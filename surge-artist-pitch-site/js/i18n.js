...
(function () {
  ...
  var EN = {
    ...
    'ins.eyebrow': 'Cover',
    'ins.lead': 'As a creator you are liable for your work, often with your private assets. Professional liability cover for media work (Markel Pro Media) catches exactly that. Answer a few short questions in the chat, see live roughly what it costs, and let us check your application.',
    'ins.dropTitle': 'Liability insurance?',
    'ins.dropHint': 'only for artists with a German billing address',
    ...
    'ins.noteOk': 'Got it',
    'ins.nudge': 'Quick aside, because you are really in it: § 12.7 gives you four weeks to show us how you are covered against late delivery. The insurance chat right under the sign-up form (“Get on the list”, one click on “Liability insurance?”) sorts that out in a few minutes.',

    /* insurance funnel — the cover spelled out, inside the dropdown */
    'ins.f.intro': 'Everything that matters, before you start the chat. The chat asks about exactly these points and works out a rough ballpark for you along the way.',
    'ins.f.k.product': 'Product',
    'ins.f.v.product': 'Professional liability cover for media work, Markel Pro Media. NIMMERSATT arranges it, Markel carries the risk.',
    'ins.f.k.who': 'Who it is for',
    'ins.f.v.who': 'Artists who are registered in Germany and whose billing address is in Germany. Without both, this partner cannot make you an offer; the chat then takes you straight into the § 12.7 branch.',
    'ins.f.k.covers': 'What it covers',
    'ins.f.v.covers': 'Pure financial loss caused by your work, above all late delivery and poor delivery. Injury, property and rented-property damage on set, on location or in the office come on top as optional public liability.',
    'ins.f.k.fields': 'Fields',
    'ins.f.v.fields': 'Video, film & content · graphic, web & design · marketing & media agency · writing, editorial & publishing · music, audio & events · consulting / services.',
    'ins.f.k.sum': 'Sum insured',
    'ins.f.v.sum': 'For financial loss: €300,000, €500,000, €1m (recommended), €2m, €5m or €10m.',
    'ins.f.k.sb': 'Deductible',
    'ins.f.v.sb': '€0, €250, €500 or €1,000 per claim. A higher deductible means a lower premium.',
    'ins.f.k.bhp': 'Public liability',
    'ins.f.v.bhp': 'Optional on top, €3m or €5m combined for injury, property and rented-property damage.',
    'ins.f.k.mods': 'Add-ons',
    'ins.f.v.mods': 'All optional: cyber & own data loss approx. €96/yr · own damage cover approx. €72/yr · print own damage approx. €48/yr · extended event cover up to 250 people approx. €84/yr · D&O external liability approx. €60/yr.',
    'ins.f.k.price': 'Premium',
    'ins.f.v.price': 'The estimate in the chat is built from your field, your annual net revenue (up to €50,000, €100,000, €250,000, €500,000 or above), the sum insured, the deductible and the add-ons you pick, with a floor of €120 a year. It is an order of magnitude, not a Markel premium.',
    'ins.f.k.term': 'Term and payment',
    'ins.f.v.term': '1 year with automatic renewal, or 3 years. Payment yearly (no surcharge), half-yearly or quarterly. Cover starts on the date you ask for.',
    'ins.f.k.asks': 'What the chat asks',
    'ins.f.v.asks': 'First the tariff and the cover, then the risk questions: claims or pending disputes in the last 3 to 5 years, circumstances you already know of that could turn into future claims, a business founded in the last 12 months, your previous insurer with expiry date and reason for cancellation, the share of your revenue from the USA and Canada, and excluded activities. Your details come last: legal form, company name, salutation, first and last name, email, phone, website or social profile, postcode and city. No bank details, no IBAN, no direct debit mandate.',
    'ins.f.k.after': 'After you send it',
    'ins.f.v.after': 'What goes out is a non-binding application enquiry, not a policy. You get a reference number, NIMMERSATT checks your details, obtains the binding Markel offer and comes back to you. Before anything is concluded you receive the general terms (AVB), the insurance product information document (IPID) and the 14-day right of withdrawal notice. Your statements have to be truthful and complete (§ 19 (5) German Insurance Contract Act, VVG).',
    'ins.f.k.excl': 'Not in the standard tariff',
    'ins.f.v.excl': 'Architecture or engineering with site supervision, investment and financial advice, and the design of weapons systems or nuclear facilities. There is a special scheme for those, and you can still send the enquiry.',
    'ins.f.lawT': 'Why this comes up at all',
    'ins.f.law1': '<strong>§ 12.5</strong> If late or poor delivery on your side causes a financial loss, you are liable for it. That liability is capped at the sum insured of your professional liability cover plus your project fee. It only reaches your private assets in cases of intent, gross negligence, or where the insurer does not pay.',
    'ins.f.law2': '<strong>§ 12.7</strong> Within four weeks of a concrete offer reaching you, you show us one of three things: a) professional liability cover for late and poor delivery, b) an existing policy with comparable scope, or c) that you carry the liability yourself. So there is no obligation to buy, the insurance is simply the easiest of the three doors.',
    'ins.f.law3': '<strong>§ 14.4</strong> If NIMMERSATT is liable towards an agency or an end client for a mistake of yours, there is an internal right of recourse, as far as you are responsible for the breach.',
    'ins.f.fine': 'None of this is insurance or legal advice, a binding premium or a promise of acceptance. It only becomes binding with the reviewed offer from Markel.',
    ...
    'ins.q.hello1': 'Hey, I’m the nimmersatt Bot. In a few minutes I’ll go through your professional liability cover with you and work out live roughly what it costs.',
    ...
    'ins.q.term': 'What term would you like?',
    'ins.q.term1': '1 year (auto-renewing)',
    'ins.q.term3': '3 years',
