...
(function () {
  ...
  var EN = {
    ...
    'work.lead': 'Not somebody else\u2019s system with our logo on it, but our own, built along the way artists work: projects, tasks and conversations in one place. The web version runs, the app is what we are building now, your account is ready the moment you are on the roster.',

    'work.l1': '01 / How Nimmersatt runs',
    'work.alt0': 'Studio overview: team, templates, quotes, invoices and automations as tiles',
    'work.s0t': 'Studio',
    'work.s0m': 'Studio \u00b7 Money \u00b7 Admin',
    'work.n0h': 'The headquarters',
    'work.n0b1': 'Studio, money and admin in one place',
    'work.n0b2': 'Overview, team, templates, Meet',
    'work.n0b3': 'Quotes and invoices next to the work',
    'work.n0b4': 'Invites, automations, AI studio, AI assistant',
    ...
    'work.n3b1': 'The same data as on the desktop, no cut-down version',
    'work.n3b2': 'At risk, active and done grouped and colour-coded',
    'work.n3b3': 'Search, progress and deadline within thumb reach',
    ...
    'work.n4b4': 'Web is live, native app in progress',
    ...
    'ins.brandMeta': 'Media liability · Markel',
    'ins.brandTag': 'Cover',
