...
(function () {
  ...
  var EN = {
    ...
    'work.l1': '01 / How Nimmersatt runs',
    'work.alt0': 'Studio overview: team, approvals, analytics, quotes, invoices and automations as tiles',
    'work.s0t': 'Studio',
    'work.s0m': 'Studio \u00b7 Money \u00b7 Admin',
    'work.n0h': 'The machine room behind every booking',
    'work.n0b1': 'Studio, money and admin as three groups on one screen',
    'work.n0b2': 'Overview, team, approvals, analytics, templates, Meet',
    'work.n0b3': 'Agency, quotes and invoices right next to the work',
    'work.n0b4': 'Tiers, invites, automations, AI studio, AI assistant',
    ...
    'work.n1h': 'Progress you can check',
    'work.n1b1': '48% overall progress, one clickable bar per task',
    'work.n1b2': 'Done, in progress, blocked, open and overdue as counters',
    'work.n1b3': 'Upcoming deadlines and team with the lead below',
    'work.n1b4': 'Twelve views: dashboard, kanban, list, Gantt, calendar, workload, review, board, delivery, plan, shooting schedule, meetings',
    'work.alt2': 'Messages with the open channel, project channels and direct messages',
    'work.s2t': 'Messages',
    'work.s2m': 'Project channels \u00b7 DMs \u00b7 Agents',
    'work.n2h': 'One channel per project',
    'work.n2b1': 'Project channels kept apart from the general chatter',
    'work.n2b2': 'Open channel, projects and direct messages in one list',
    'work.n2b3': 'Unread counts per row, search across every message',
    'work.n2b4': 'Our agents in the project thread, briefing changes for everyone at once',

    'work.l3': '03 / And in your pocket',
    'work.alt3': 'Project list on a phone, grouped by at risk and active',
    'work.s3t': 'Projects, mobile',
    'work.s3m': 'Grouped \u00b7 Searchable',
    'work.n3h': 'The full project list in one hand',
    'work.n3b1': 'The same data as on the desktop, no stripped-down second version',
    'work.n3b2': 'At risk, active and done grouped and colour-coded',
    'work.n3b3': 'Search, progress, deadline and edit within thumb reach',
    'work.n3b4': 'Bottom bar: today, chat, projects, studio',
    'work.alt4': 'Sign-in on a phone, with language switch and demo mode',
    'work.s4t': 'Your way in',
    'work.s4m': 'German \u00b7 English \u00b7 Demo',
    'work.n4h': 'One way in, one login',
    'work.n4b1': 'One sign-in for web and app, on every device',
    'work.n4b2': 'German, English, demo mode for a look around',
    'work.n4b3': 'Free for everyone on the roster, structure in place from day one',
    'work.n4b4': 'Web is live today, native app in progress',
