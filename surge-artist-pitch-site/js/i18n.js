...
(function () {
  ...
  var EN = {
    ...
    'work.h': 'Our operating system.<br />SaaS, but built for us.',
    'work.lead': 'Not somebody else\u2019s system with our logo on it. We are building our own, along the way artists actually work: projects, tasks and conversations in one place. The web version runs, the mobile app is what we are on right now, and your account is ready the moment you are on the roster.',

    'work.l1': '01 / The whole studio on one screen',
    'work.alt0': 'Studio overview: team, approvals, analytics, quotes, invoices and automations as tiles',
    'work.s0t': 'Studio',
    'work.s0m': 'Studio \u00b7 Money \u00b7 Admin',
    'work.n0h': 'One home for everything the studio does',
    'work.n0b1': 'Studio, money and admin sit side by side in three groups. No digging through menus until somebody finds where the invoice lives.',
    'work.n0b2': 'Team, approvals, analytics, templates and Meet all open from the same screen.',
    'work.n0b3': 'Quotes and invoices sit next to the work they belong to, not in a separate accounting world.',
    'work.n0b4': 'Automations and the AI assistant are built in, not bolted on afterwards.',

    'work.l2': '02 / Built for the artist side',
    'work.alt1': 'Project view with overall progress, task bars, upcoming deadlines and team',
    'work.s1t': 'Project',
    'work.s1m': 'Progress \u00b7 Deadlines \u00b7 Team',
    'work.n1h': 'A project that is honest about where it stands',
    'work.n1b1': 'One percentage, and under it one bar per task. Every bar is clickable, so the 48% is not a claim, it is something you can check.',
    'work.n1b2': 'Done, in progress, blocked, open and overdue are counted, not guessed.',
    'work.n1b3': 'Upcoming deadlines and the team sit right below, with the lead and everyone else on it.',
    'work.n1b4': 'Twelve views on the same data: dashboard, kanban, list, Gantt, calendar, workload, review, board, delivery, plan, shooting schedule, meetings.',
    'work.alt2': 'Messages with the open channel, project channels and direct messages',
    'work.s2t': 'Messages',
    'work.s2m': 'Project channels \u00b7 DMs \u00b7 Agents',
    'work.n2h': 'The conversation stays with the project',
    'work.n2b1': 'Every project has its own channel. General chatter lands somewhere else.',
    'work.n2b2': 'Open channel, projects and direct messages in one list, unread counts included.',
    'work.n2b3': 'Our agents write into the project thread themselves, so a change to the briefing reaches everyone at the same time.',
    'work.n2b4': 'No lost links, no voice note buried in somebody\u2019s private chat.',

    'work.l3': '03 / And it fits in your pocket',
    'work.alt3': 'Project list on a phone, grouped by at risk and active',
    'work.s3t': 'Projects, mobile',
    'work.s3m': 'Grouped \u00b7 Searchable \u00b7 Thumb-friendly',
    'work.n3h': 'The full project list on a phone',
    'work.n3b1': 'The same data as on the desktop, not a stripped-down second version.',
    'work.n3b2': 'At risk, active and done are grouped and colour-coded before you read a word.',
    'work.n3b3': 'Search, progress, deadline and edit all sit within thumb reach.',
    'work.n3b4': 'The bottom bar takes you to today, chat, projects and studio in one tap.',
    'work.alt4': 'Sign-in on a phone, with language switch and demo mode',
    'work.s4t': 'Your way in',
    'work.s4m': 'German \u00b7 English \u00b7 Demo',
    'work.n4h': 'Your account, and the app is on its way',
    'work.n4b1': 'One sign-in, in German or English, same access on every device.',
    'work.n4b2': 'Demo mode lets you look around before you create anything.',
    'work.n4b3': 'Free for everyone on the roster, and the structure is already there before you walk in.',
    'work.n4b4': 'What you see here runs in the browser today. The native app is what we are working on right now.',
