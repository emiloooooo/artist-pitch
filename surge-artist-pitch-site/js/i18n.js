...
(function () {
  ...
  var EN = {
    ...
    'ins.info.cost.6': 'Term of 1 year with automatic renewal, or 3 years. Payment yearly (no surcharge), half-yearly or quarterly. Cover starts on the date you ask for.',
    ...
    'ins.info.ask.2': 'Your details come last: legal form, company name, salutation, first and last name, email, phone, website or social profile, postcode and city. No bank details, no IBAN, no direct debit mandate.',
